            ...
            <div className="bg-gray-800 rounded-lg p-4 border border-gray-700">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <span className="text-gray-400 text-sm">Apertus Downloads</span>
                ...
                <div className="border-t border-gray-700"></div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-400 text-sm">Total Repos Tracked</span>
                  <span className="text-white font-medium">{githubRepos?.length || 0}</span>
                </div>
              </div>
            </div>
              ...
              <div className="bg-gray-800 rounded-lg p-4 border border-gray-700">
                <div className="space-x-2">
                  {data?.models.map(m => (
                    <label
                      key={m.id}
                      className="gap-3 rounded hover:bg-gray-700 cursor-pointer transition-colors"
                    ...
                    >
                      ...
                      />
                      &nbsp;
                      <span className="text-gray-200 bg-gray-800">&nbsp;{m.name}</span>
                    </label>
                  ))}
                </div>
              </div>
